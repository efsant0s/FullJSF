...
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "Usuario{" + "id=" + id + ", login=" + login + ", password=" + password + ", nome=" + nome + ", telefone=" + telefone + ", email=" + email + ", respostaSeguranca=" + respostaSeguranca + ", iePermissao=" + iePermissao + '}';
    }
